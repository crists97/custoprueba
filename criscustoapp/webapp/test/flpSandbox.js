		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cris app",
									"targetURL": "#comcriscustocriscustoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcriscustocriscustoapp-display": {
								"semanticObject": "comcriscustocriscustoapp",
								"action": "display",
								"description": "A Fiori application - Cris app",
								"title": "Cris app",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.criscusto.criscustoapp",
									"url": sap.ui.require.toUrl("com/criscusto/criscustoapp")
								}
							}
						}
					}
